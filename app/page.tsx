...
export default function ImpactOSDashboard() {
  ...
  return (
    <div className="bg-[#fcfaf8] min-h-screen">
      <div id="dashboard-content" className="max-w-[1440px] mx-auto px-4 py-5 sm:px-6 sm:py-6 md:px-8 md:py-8 lg:px-10 lg:py-10 font-sans text-[#0a192f]">
        
        {/* 1. COMMON HEADER (Ye har report me aayega) */}
        <div id="dashboard-header" className="mb-8">
          <Header />
        </div>

        {/* 2. OVERVIEW SECTION (Sirf ESG Report ke liye) */}
        ...
        {/* 5. CSR SECTION (Sirf CSR Report ke liye) */}
        <div id="section-csr" className="space-y-8 sm:space-y-10 lg:space-y-12 mt-8 sm:mt-10 lg:mt-12">
          <CSRCalculator />
          <FutureScaleCTA />
        </div>

        {/* DOWNLOAD BUTTONS WALA SECTION */}
